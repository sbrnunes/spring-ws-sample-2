...
@XmlRootElement(name = "UploadPerformanceDataResponse")
public class UploadPerformanceDataResponse {

    @XmlElementRef(name = "RequestId", namespace = "http://www.eurodw.eu/EDServices/1.0", type = JAXBElement.class)
